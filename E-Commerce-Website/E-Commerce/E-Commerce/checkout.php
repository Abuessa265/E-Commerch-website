                            ...
                            <div class="row g-0">
                                <div class="col-xl-12 bg-grey">
                                    <div class="p-5">
                                        ...
                                        <h3 class="text-uppercase mb-3">Select Payment Method</h3>

                                        <!-- if bkash or bitcoin Select h3 will show -->
                                        <h5 style="color: #d42c2c;">Currently Not available</h5>
                                        <label class="radio_img">
                                            <input type="radio" name="test" value="small" checked>
                                            <img class="payment_m" src="images/cod.png" alt="Option 1">
                                        </label>

                                        <label>
                                            <input type="radio" name="test" value="big">
                                            <img class="payment_m" src="images/bkash.png" alt="Option 2">
                                        </label>
                                        <label>
                                            <input type="radio" name="test" value="big">
                                            <img class="payment_m" src="images/nagad.png" alt="Option 2">
                                        </label>
