...
<head>
    ...
    <title>RedHut | Forgot Password</title>
</head>
                                ...
                                <div class="otp_send_form">
                                    ...
                                    <form action="" method="post">
                                        <div class="form-outline mb-5">
                                            <input type="text" name="otp" placeholder="Enter OTP" class="form-control form-control-lg" style="width:30rem !important" required />
                                        </div>
                                        <div class="d-flex justify-content-center">
                                            <button type="submit" name="submit" style="background: #3bd4ff;" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">SUBMIT</button>
                                        </div>
                                    </form>
                                </div>
