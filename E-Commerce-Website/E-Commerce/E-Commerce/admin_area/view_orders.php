...
<head>
    ...
    <title>RedHut | Admin | View Order</title>
                ...
                <tbody>
                    ...
                    if ($result) {
                        while ($data = mysqli_fetch_array($result)) {
                            ...
                            <td><img src="../product_img/' . $p_img . '" alt="" style="width:100px; height:100px; object-fit:contain; !important"></img></td>
                            <td>' . $p_name . '</td>
                            <td>' . $c_name . '</td>
                            <td>' . $c_email . '</td>
                            <td>' . $invoice . '</td>
                            ...
                            <td>' . $status . '</td>
                            <td>
                            <a href="mail_area/mail2.php?id=' . $order_id . "/" . $product_id . "/" . $quantity . "/" . $invoice . ' " style=""><i class="fas fa-check-circle fa-2x text-success"></i></i></a>
