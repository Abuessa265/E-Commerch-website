                        ...
                        <form action="add_product.php" class="form-container" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select" id="inputGroupSelect01" name="p_ctag">
                                    ...
                                    <option value="Electronic " style="background-color:#263024 ;color: aliceblue;">Electronic</option>
                                </select>
                            </div>
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select" id="inputGroupSelect01" name="p_sub_ctag">
                                    <option selected>Choose...</option>
                                    <option value="Mobile" style="background-color: #333454;color: aliceblue;">Mobile</option>
                                    <option value="Laptop" style="background-color: #333454;color: aliceblue;">Laptop</option>
                                    <option value="Head Phone" style="background-color: #333454;color: aliceblue;">Head Phone</option>
