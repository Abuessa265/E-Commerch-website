...
try {
    ...
    $mail->Body    = ('Hello ' . $username . ',<br>We are sorry, your order has been canceled as the product is currently unavailable to us.<br><br>Visit your profile for view your product status.<br><br>Stay with us. Take Care<br><br><hr>Thanks,<br>The Fashion-store Team');
