...
try {
    ...
    password.<br><br>Your OTP is: <strong>' . $otp . '</strong><br><br>If you didn’t request for password reset, Don’t share it with others and You can ignore this message.<br><br><hr>Thanks,<br>The RedHut-store Team');
    // $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';

    if ($mail->send()) {
        echo '<script>alert("Message has been sent to your mail")</script>';
        echo '<script>window.open("../check_otp.php","_self")</script>';
    } else {
