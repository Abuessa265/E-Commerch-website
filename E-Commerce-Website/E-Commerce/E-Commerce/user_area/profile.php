...
<body>
                        ...
                        <div class="col-lg-8">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <p class="mb-0">Your Discount</p>
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="text" style="width:80px;border: none" value='<?php echo CURRENCY . '. ' . $discount; ?>' readonly>
                                        </div>
                                        <div class="col-sm-5">
                                            <?php
                                            if ($discount > 0 and $get_discount == 0) {
                                                echo '<form action="" method="post"><button type="submit" class="btn btn-info" style="font-size:10px;color:white" name="get_discount">Get Discount</button></form>';
                                            }
                                            ?>
    ...
    if (isset($_POST['get_discount'])) {
        $sql = "update `user_info` set discount='0' where username='$username'";
        $res = mysqli_query($con, $sql);
        if ($res) {
            $sql = "update `user_info` set buy_product='0', get_discount='1', discount='$discount' where username='$username'";
            $res = mysqli_query($con, $sql);
            if (!$res) {
